...
La plataforma de Ushahidi, es un esfuerzo muy similar en sus orígenes a la solución implementada en ~#Verificado19s~, ambas soluciones hacen uso de un grupo de voluntarios que con sus teléfonos móviles proveen información para un ente centralizador que luego publica la información en un mapa en línea.

Sin embargo cuando fue considerada como solución, el precio por el despliegue en ese momento era alrededor de 500 USD por mes\cite{previouscost} y no contábamos con recursos monetarios líquidos en ese momento.  Ushahidi evolucionó a una empresa que hace despliegues de la plataforma con costo\cite{costeushahidi}.  El código abierto fue consultado y resultó ser demasiado complejo para el equipo que se tenía disponible. El estimado que se tuvo de implementación era mucho más de una semana, por lo que no se hizo un despliegue de Ushahidi.

La recolección de información por parte de Ushahidi es mucho más diversa: recolecta información de SMS's, correos electrónicos, página web, aplicaciones móbiles y Twitter. Por otro lado la capa de recolección de  ~#Verificado19s~, fue mucho más limitada: sólo se recibían puntos de información através de los Google Forms.

La principal diferencia entre lo que Ushahidi ofrece y lo que se construyó en ~#Verificado19s~, es que Ushahidi provee capacidad de mapeo de información sin poder verificar los puntos. La capa de verificación fue un componente fundamental en la herramienta implementada en el colectivo.  Por lo demás, la plataforma de Ushahidi es una evolución de una idea similar a ~#Verificado19s~.
